 ...
 * @author RAD4R
 * @authorLink https://github.com/RAD4R911/RAD4RFAKEDEAFEN
 * @version 1.0.5
 * @description Listen or even talk in a voice chat while being self-deafened.
 * @website https://github.com/RAD4R911/RAD4RFAKEDEAFEN
 * @source https://github.com/RAD4R911/RAD4RFAKEDEAFEN/blob/main/RAD4RFAKEDEAFEN.plugin.js
 * @updateUrl https://raw.githubusercontent.com/RAD4R911/RAD4RFAKEDEAFEN/main/RAD4RFAKEDEAFEN.plugin.js
 */
...
module.exports = (() => {
    const config = {
        "info": {
            ...
            "version": "1.0.5",
            "description": "Listen or even talk in a voice chat while being self-deafened.",
            github: "https://github.com/RAD4R911/RAD4RFAKEDEAFEN",
            github_raw: "https://raw.githubusercontent.com/RAD4R911/RAD4RFAKEDEAFEN/main/RAD4RFAKEDEAFEN.plugin.js"
        },
        "changelog": [{
            "type": "fixed",
            "title": "Fixed",
    ...
    return !global.ZeresPluginLibrary ? class {
        ...
        const plugin = (Plugin, Api) => {
            ...
            return class RAD4RFAKEDEAFEN extends Plugin {
                onStart() {
                    this.fixated = false;
                    this.patches();
                    this.panelButton();
